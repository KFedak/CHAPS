...
```{r}
plot(pred.pol, "overall", ci="lines", ylim=c(-1,1), lwd=2, col=4,
  xlab="PM2.5", ylab="FVC", 
  main="Overall effect")
```
...
legend("topright", paste("PM2.5 =",c(5,15,25,35)), col=2:4, lwd=1.5)
...
plot(pred.pol, var=c(5,10,15,20,35), lag=c(0,1,2,3,30), ci.level=0.95, col=2, 
